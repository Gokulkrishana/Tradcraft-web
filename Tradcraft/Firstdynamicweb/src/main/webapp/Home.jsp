...
<body>
        ...
        <nav class="navbar p-3 navbar-expand-md navbar-dark fixed-top">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                ...
                <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item px-3">
                        <a class="nav-link" href="Profile.jsp?uname= <%= session.getAttribute("uname") %>"><i class="fa-solid fa-user"></i> <%= session.getAttribute("uname") %></a>
                    </li>
                    <li class="nav-item px-3">
    ...
    <main>
		...
		<section class="upload p-3 mb-3" style="margin-top: 5%">
                ...
                <div class="card shadow mt-5">
                    ...
                    <div class="card-body">
                        <form action="Home" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="ifile" class="form-label">Choose Image</label>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            try {
                ...
                String query = "SELECT imagefilename, iname FROM IMG WHERE category = ?";
