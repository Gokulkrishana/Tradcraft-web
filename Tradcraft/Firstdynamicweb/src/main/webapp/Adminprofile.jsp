...
<body>
        ...
        <nav class="navbar p-3 navbar-expand-md navbar-dark fixed-top">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                ...
                <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item px-3">
                        <a class="nav-link active" href="Profile.jsp?username=<%= session.getAttribute("uname") %>"><i class="fa-solid fa-user"></i> <%= session.getAttribute("uname") %></a>
                    </li>
                    <li class="nav-item px-3">
    ...
    <main>
		...
		%>
        <section class="signup mb-5" style="margin-top: 6%">
            <div class="container">
                <form action="Adminedit.jsp" class="validation" method="post">
                    <table class="m-auto mt-5">
                      <% 
                        	...
                        	String query ="SELECT uname,email,address,city,phonenumber FROM REGISTER WHERE uname = ?";
                    	...
                    	<tr>
                    	<td align="m-auto"><h2 class="text-center">Profile</h2></td>
                    	</tr>
                        <tr>
                            <td>
                                <div class="mb-3">
                                   ...
                                   <input type="email" class="form-control" name="mail" id="e-mail"
                                        aria-describedby="helpId" placeholder="<%= name %>" disabled/>
                                </div>
                            </td>
                            <td>
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" name="mail" id="e-mail"
                                        aria-describedby="helpId" placeholder="<%= email %>" disabled/>
                                </div>
                            </td>
                        </tr>
                        <br>
                            ...
                            <td>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="city" id="city"
                                        aria-describedby="helpId" placeholder="<%= city %>" disabled />
                                </div>
                            </td>
                        </tr>
                        <br>
                            ...
                            <td colspan="2">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" name="pnumber" id="pnumber"
                                        aria-describedby="helpId" placeholder="<%= pnumber %>" disabled />
                                </div>
                            </td>
                        </tr>
                        <tr>
